<x-guest-layout>
    ...
    <div class="bg-[#004B93] pt-8 pb-16 text-center text-white px-4">
        <h1 class="text-2xl md:text-4xl font-black italic tracking-tighter">Mulai Bisnis Bersama Kami</h1>
        <p class="text-blue-100 mt-2 max-w-xl mx-auto text-sm md:text-base font-medium">
            Jadilah bagian dari Jaringan Reseller Terbesar di Cikarang. Akses harga distributor untuk profit harian yang maksimal.
        </p>
    </div>

    <div class="max-w-7xl mx-auto px-4 py-16 -mt-12 relative z-10">
        {{-- Keuntungan Section (Tambahan) --}}
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
            ...
            <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 text-center group hover:bg-[#FF2800] transition-all duration-300">
                <div class="text-2xl mb-2">{{ $benefit[0] }}</div>
                <p class="text-[10px] font-black uppercase text-slate-800 group-hover:text-white tracking-widest">{{ $benefit[1] }}</p>
            </div>
            @endforeach
        </div>
            ...
            <div class="lg:col-span-2 space-y-10 py-6">
                <div>
                    <h2 class="text-3xl font-black text-slate-800 leading-tight uppercase italic tracking-tighter">
                        Cara Mudah <br> <span class="text-[#FF2800]">Mulai Bisnis</span>
                    </h2>
                    <p class="text-slate-500 mt-4 leading-relaxed font-medium">Fokus kami adalah membantu Anda tumbuh. Tanpa biaya pendaftaran yang rumit.</p>
                </div>
            ...
            <div class="lg:col-span-3 bg-white rounded-[3rem] shadow-xl border border-slate-100 p-8 md:p-12 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <div class="mb-10">
                        ...
                        <p class="text-slate-400 text-sm mt-1">Khusus wilayah Cikarang dan sekitarnya.</p>
                    </div>
                    ...
                    <form id="resellerForm" class="space-y-5">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="space-y-2">
                                <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Domisili Area</label>
                                <input type="text" id="location" required class="w-full bg-slate-50 border-slate-200 rounded-2xl px-5 py-4 text-sm font-bold focus:ring-[#004B93] focus:border-[#004B93] transition" placeholder="Contoh: Jababeka">
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <select id="type" required class="w-full bg-slate-50 border-slate-200 rounded-2xl px-5 py-4 text-sm font-bold focus:ring-[#004B93] focus:border-[#004B93] transition">
                                ...
                                <option value="Reseller Rumahan">Reseller Rumahan (Punya Freezer)</option>
                                <option value="Jastip Frozen">Jastip / Pre-Order (Tanpa Freezer)</option>
                                <option value="Toko Sembako">Warung / Toko Kelontong</option>
                            </select>
                        </div>

                        <div class="space-y-2">
                            <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Pesan Tambahan</label>
                        ...
                        <button type="submit" class="w-full bg-[#FF2800] text-white font-black py-5 rounded-2xl shadow-lg hover:bg-red-700 transition transform active:scale-95 flex items-center justify-center gap-4 group">
                            ...
                            <span class="tracking-widest italic uppercase">Kirim ke WhatsApp Admin</span>
                        </button>
                    </form>
                </div>
            </div>
    ...
    <script>
        document.getElementById('resellerForm').addEventListener('submit', function(e) {
            ...
            const waNumber = "6282260801567";

            const text = `Halo Admin Alfa Frozen Jaya,\n\nSaya ingin mendaftar sebagai *Reseller Cikarang*.\n\n*Profil Pendaftar:*\n- Nama: *${name}*\n- Domisili: *${location}*\n- Kategori: *${type}*\n\n*Pesan:* ${note}`;
